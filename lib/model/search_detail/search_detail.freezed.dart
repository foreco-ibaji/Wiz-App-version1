...
class _$SearchDetailImpl implements _SearchDetail {
  const _$SearchDetailImpl({required this.text, required this.dateTime});
  ...
  @override
  String toString() {
    return 'SearchDetail(text: $text, dateTime: $dateTime)';
  }
...
abstract class _SearchDetail implements SearchDetail {
  const factory _SearchDetail(
      {required final String text,
      required final DateTime dateTime}) = _$SearchDetailImpl;
